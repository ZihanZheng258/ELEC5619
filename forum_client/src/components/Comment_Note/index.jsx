...
const Comment_Note =(props) =>{
    ...
    const handleSubmit = event => {
        ...
        api.postNoteComment(noteID,target.targetID,parent.parentID,1,replyMessage)
            .then(()=>{
